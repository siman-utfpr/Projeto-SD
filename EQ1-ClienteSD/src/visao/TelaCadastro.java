...
public class TelaCadastro extends javax.swing.JFrame {
    ...
    private void jButtonCadastrardefinirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrardefinirButtonActionPerformed
        try {
            // TODO add your handling code here:
            GerenciadorUsuario.conectarUsuario();
            ...
            if (GerenciadorUsuario.fazerCadastroUsuario(email, nomeUsuario, senha)) {
                JOptionPane.showMessageDialog(null, "Usuario cadastrado com sucesso");
                FabricaVisoes.mostrarTelaLogin();
                FabricaVisoes.esconderTela("TelaCadastro");
            } else {
                JOptionPane.showMessageDialog(null, "Erro no cadastro do usuario");
            }
